...
\usepackage{caption}
\captionsetup[figure]{
	labelfont=bf,             % Pone en negrita la etiqueta ("Figura 1.")
	labelsep=period,     % Usa un punto para separar "Figura 1." del texto (o 'colon' para dos puntos)
	justification=centering,  % Centra la leyenda completa debajo de la imagen
	labelformat=simple,  % Mantiene la etiqueta estándar en la misma línea
	textfont=it,          % Si quieres mantener el texto del título en cursiva
	singlelinecheck=false     % Asegura que el centrado se aplique siempre
}
